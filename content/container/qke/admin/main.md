...
存储、网络等插件通过 API 密钥与云平台交互并创建资源，需要通过 [API 密钥管理页面](https://console.shanhe.com/access_keys/) 预先创建好。
...
| 参数 | 描述
| -- | --
| API 密钥 | shanhe IaaS API 密钥 (https://console.shanhe.com/access_keys/)，此密钥将被用来创建云平台的资源，比如负载均衡器、PV 挂盘等
