...
当您准备自己在云上开发一款应用，需要在该应用中调用 shanhe API/CLI （例如： StopInstances 停止云服务器）以完成某些功能时，过去您可能需要利用自己的账户 API 密钥作为该应用配置项在有需要时连接使用。
...
3.将 shanhe 官方 SDK 引用到这款应用的身份鉴权代码中（本例中为 Python SDK）
