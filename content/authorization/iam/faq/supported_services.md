...
**服务类别**指的是 shanhe 平台为客户提供的一系列云服务，如弹性云服务器服务、虚拟专用网服务等。

若您决定针对性的创建策略以定义某些操作或资源的访问权限，您需要先选择对应的服务类别，然后勾选需要限定的操作，最后根据操作来指定权限范围。

在您编辑[策略](../../manual/policy)或指定[资源标识符 QRN](../../faq/qrn)时，您可能需要了解 shanhe 平台上的服务类别、区域、操作指令，以及它们与 shanhe 资源类型之间的关系。

> 只有经过 IAM 集成的服务才可以创建自定义策略，暂未集成的服务将会默认被 IAM 评估拒绝。
>
> 目前并非所有的 shanhe 服务都可以通过 IAM 来控制访问权限。

## 服务类别

目前 shanhe IAM 暂时支持以下几种服务类别以及对应 ID：
...
更多详细信息，请参考[区域和可用区指南](https://docs.shanhe.com/product/region/#区域和可用区指南)
