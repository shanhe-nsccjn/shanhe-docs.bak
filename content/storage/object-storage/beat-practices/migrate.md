...
OIS 推出了无缝数据迁移方案，帮助用户将业务数据从自建平台或者其他对象存储平台高效完整地迁移到 对象存储服务OIS服务。
...
下面结合示意图，说明外部镜像的工作原理: 假设用户的外部镜像源站为 [http://img.example.com](http://img.example.com) , 在OIS 的 Bucket 的默认域名为 [http://bucketname.jn1.is.shanhe.com](http://bucketname.jn1.is.shanhe.com) 。
...
> 外部镜像 API 请参考文档 [Bucket External Mirror](https://docsv3.shanhe.com/storage/object-storage/api/bucket/external_mirror/)
>
