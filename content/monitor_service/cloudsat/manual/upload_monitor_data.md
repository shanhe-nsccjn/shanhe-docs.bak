...
分区信息参考：济南1区（jn1）、济南1区-A（jn1a）、上海1区（sh1）、广东2区（gd2）、亚太2区-A（ap2a）
...
实际使用过程中请替换成你自己的AccessKeyId，切换相应区间信息。签名验证可以参考[山河API 请求中签名 ( signature )]( /development_docs/api/signature/)，使用链接文档中数据签名结果如果和链接中的一致代表签名方法正确。
